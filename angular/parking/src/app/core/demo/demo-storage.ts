 ...
 *
 * Mientras Firebase no esté configurado, las solicitudes y los avisos se guardan
 * en el navegador para que el flujo completo (registrar como estudiante, revisar
 * como administrador) sobreviva a una recarga de la página.
 *
 * TODO: todo lo de esta carpeta desaparece cuando existan Firestore y Storage.
 */
import { isFirebaseConfigured } from '../config/firebase.config';

const PREFIX = 'uniparking.demo.v1.';
